      ...
      confirmDeleteBtn.addEventListener("click", function() {
          ...
          xhr.open("POST", "/BIS/administrator/admin_panel/admin_folder/delete.php", true);
          xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
          xhr.send("id=" + id);
          xhr.onload = function() {
              if (xhr.status === 200) {
                  // Refresh page or update table
                  window.location.href = "/BIS/administrator/admin_panel/admin_folder/loading_delete.php";
