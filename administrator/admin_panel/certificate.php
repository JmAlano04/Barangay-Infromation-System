            ...
            <ul class = "nav_list">
                    ...
                    <li>
                        ...
                        <span class = "tooltip">Documents</span>
                         ...
                         <button id = "clearance" onclick="loadContent('certificate_folder/clearance.php')" >Barangay Clearance
                             <span class = "notif" id = "clearance_notif">
                            <?php clearance_notif()?>
                        </span>
                         </button>
                          
                         <button id = "indigency" onclick="loadContent('certificate_folder/indigency.php')" >Barangay Indigency
                       
                          <span class = "notif" id = "indigency_notif">
                           <?php indigency_notif() ?>
                        </span>
                         </button>
                       
                         <button id = "barangay_id" onclick="loadContent('certificate_folder/ID.php')" >Barangay I.D
                            <span class = "notif" id = "id_notif" style="margin-left:80px;">
                                  <?php id_notif() ?>
                        </span>
                         </button>
                        <br>
                         ...
                         <button id = "barangay_id" onclick="loadContent('certificate_folder/cedula.php')" >Barangay Cedula
                              <span class = "notif" id = "cedula_notif"  style="margin-left:50px;">
                                     <?php cedula_notif() ?>
                                </span>
                         </button>
...
<!-- -------------------------------------JAVASCRIPT--------------------------------------------- -->
        ...
        <script src = "certificate_folder/javascript/import.js"> </script>
          <!-- DELETE BUTTON -->
